...
case class Contact (id: String, name: String, category: String, company: Option[String], notifyEmail: String, phone: Option[String], adminEmail: Option[String], fromDate: Option[String], tillDate: String, isImportant: Boolean, nextNotificationAllowedAt: Option[String], deputy: Notifee)
...
case class Updated(updatedAt: String)