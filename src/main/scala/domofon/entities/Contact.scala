...
case class Contact (id: String, name: String, category: String, company: Option[String], notifyEmail: String, fromDate: Option[String], tillDate: String, isImportant: Boolean, nextNotificationAllowedAt: Option[String], deputy: Notifee)
